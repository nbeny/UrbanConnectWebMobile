...
const defaultTheme: ThemeConfig = {
  ...
  backgroundOverlay: 'linear-gradient(135deg, rgba(199, 109, 109, 0.08), rgba(250, 248, 246, 0.05) 60%, transparent 90%)',
  
  primaryText: '#ffffff',
  secondaryText: '#ffffff',
  accentColor: '#ffffff', // Rose poudré doux
...
export const useTheme = (profileId?: string) => {
  ...
  const getThemeStyles = useCallback(() => {
    ...
    return {
      ...
      textPrimaryStyle: { color: theme.primaryText },
      textSecondaryStyle: { color: theme.secondaryText },
